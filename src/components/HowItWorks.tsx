  ...
  const steps = [
    {
      ...
      description:
        "Tell us your event details: date, location, attendees, budget, and preferences. Takes less than 2 minutes.",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Our intelligent algorithm instantly analyzes thousands of vendors, scoring them on rating, price, location, and availability.",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Selected vendors are checked for real-time availability. All bookings are confirmed simultaneously to ensure no conflicts.",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      title: "Event Ready",
      description:
        "Get instant confirmations, auto-generated contracts, and coordinated communication with all vendors. Your event is ready!",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
