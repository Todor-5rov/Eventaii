  ...
  const benefits = [
    {
      title: "More Bookings",
      description:
        "Get matched with qualified clients automatically. No cold calls or advertising costs.",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Secure escrow payments released automatically after event completion. No payment chasing.",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Automatic calendar integration prevents double-bookings and optimizes your availability.",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Track bookings, ratings, and revenue. Optimize pricing based on demand patterns.",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Join thousands of vendors getting high-quality bookings
            automatically. Our AI matches you with perfect-fit clients 24/7.
          </p>
        </div>
