      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
          <a href="/register-organizer" className="w-full sm:w-auto">
            <button className="w-full px-8 py-4 bg-white text-primary-600 text-lg font-semibold rounded-xl hover:shadow-2xl hover:scale-105 transition-all">
              Get Started Free
            </button>
          </a>
          <a href="/register-vendor" className="w-full sm:w-auto">
            <button className="w-full px-8 py-4 bg-transparent text-white text-lg font-semibold rounded-xl border-2 border-white hover:bg-white hover:text-primary-600 transition-all">
              Become a Vendor
            </button>
          </a>
        </div>
