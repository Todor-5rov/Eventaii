        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Stop juggling endless emails, phone calls, and spreadsheets. Our
              AI handles vendor selection, booking, and coordination
              automatically, so you can focus on creating amazing experiences.
            </p>
